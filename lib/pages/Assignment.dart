...
class _AssignmentPageState extends State<AssignmentPage>
  ...
  void _toggleView() {
    setState(() {
      _showingSavedNotes = !_showingSavedNotes;
    });
  }

   void _showSavedNotesBottomSheet() async {
  final directory = await getExternalStorageDirectory();
  final downloadPath = Directory('${directory!.path}/StudyMate/Assignments');
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Available assignments to download',
                              style: TextStyle(
                                fontSize: 14,
            ...
            // Main Content - Available Assignments
            Expanded(
              child: FadeTransition(
                opacity: _fadeAnimation,
                child: const OnlineSection(notePrefix: "Available Assignment"),
              ),
            ),
          ],
        ),
...
class NotesSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (notePrefix == "Available Assignment") {
